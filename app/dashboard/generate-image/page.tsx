        ...
        <section className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <div className="mx-auto max-w-6xl">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">Crie imagens profissionais com DALL-E 3</p>
            </div>
                  ...
                  <form onSubmit={handleGenerate} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={quality} onValueChange={setQuality} disabled={isLoading}>
                        ...
                        <SelectContent>
                          <SelectItem value="standard">Padrão (5 créditos)</SelectItem>
                          <SelectItem value="hd">Alta Definição (5 créditos)</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
